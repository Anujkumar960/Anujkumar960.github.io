      ...
      <div className="Intro" id="intro">
        <div className="i-left">
          <div className="i-name ">
            ...
            <span className="animate-charcte name anim">Kshatriya Anujkumar</span>
          ...
          <button
            onClick={() =>
              window.open(
                "https://drive.google.com/file/d/1oEVVj8aX9iX018583p1QZ1y-C5v23Emo/view?usp=sharing"
              )
            }
          ...
          <div className="i-icons">
            <a
              href="https://github.com/Anujkumar960"
              target="_blank"
              rel="noopener noreferrer">
              <img src={Github} alt="github" />
            </a>
            <a
              href="https://www.linkedin.com/in/anuj8//"
              target="_blank"
              rel="noopener noreferrer">
